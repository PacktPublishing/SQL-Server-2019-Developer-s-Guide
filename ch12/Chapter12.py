...
# Reading a CSV file
TM = pd.read_csv("C:\SQL2019DevGuide\Chapter12_TM.csv")
...
# Of course, the next line produces an error
np.vstack([a1, a3])
...
plt.show()
f.savefig('C:\\SQL2019DevGuide\\B12937_12_04.png')
...
sns.countplot(x="Education", hue="BikeBuyer", data=TM);
plt.show()
f.savefig('C:\\SQL2019DevGuide\\B12937_12_05.png')
